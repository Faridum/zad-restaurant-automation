...
try {
  ...
  if ($_SESSION['role'] !== 'owner') {
    echo json_encode(['status' => 'error', 'message' => 'غير مصرح لك بإضافة منتجات.']);
    exit;
  }
  ...
  echo json_encode([
    'status' => 'error',
    'message' => 'يرجى إدخال كمية صحيحة للمنتج.'
  ]);
  exit;
}
  ...
  echo json_encode(['status' => 'success', 'message' => 'تمت إضافة المنتج بنجاح ✅']);
  exit;
